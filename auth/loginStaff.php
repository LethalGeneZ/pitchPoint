...
require_once __DIR__ . '/controller/StaffAuthController.php';
...
<head>
    <meta charset="utf-8">
    <title>Staff Login - PitchPoint</title>
...
<div class="login-container">
    ...
    <?php if (!empty($_GET['err'])): ?>
        <div class="message error">
            <?php
                ...
                elseif ($err === 'bad') echo 'Invalid credentials or you are not a staff member.';
    ...
    <form method="post" action="/pitchPoint/pitchpoint_staff/public/staff.php?action=dologin">
